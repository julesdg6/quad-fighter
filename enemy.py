...
class Enemy:
    ...
    def draw(self, screen):
        ...
        pygame.draw.line(screen, (70, 70, 70), (left_shoulder_x, shoulder_y), (arm_reach_x, arm_reach_y), 3)
        pygame.draw.line(screen, (60, 60, 60), (right_shoulder_x, shoulder_y), (rear_arm_x, rear_arm_y), 3)
